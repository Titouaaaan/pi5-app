...
export default function Resume() {
  return (
    <main className="flex min-h-screen bg-gray-300 text-black text-1xl"
    style={{
      ...
      backgroundRepeat: "no-repeat", // Prevents the GIF from repeating
        ...
        <section className="sticky top-0 h-screen w-1/4 p-10 text-white bg-black bg-opacity-50 rounded-xl p-10 ">
          <div className="text-center flex-grow">
            ...
            />
            <p className="italic mb-4 font-bebas text-1xl">&quot;Master Student at Sorbonne Université🥐&quot;</p>
      ...
      <section className="w-3/4 p-10 overflow-y-auto font-bebas bg-opacity-70 rounded-xl p-10">
        {/* Experience Section */}
        <section className="bg-white shadow-lg rounded-lg p-6 mb-6">
          <h2 className="text-5xl font-semibold text-gray-800 mb-4">Experience</h2>

          <div className="mb-6">
            <div className="flex items-center space-x-4"> 
              <h3 className="text-3xl font-bold text-gray-700">Research Assistant</h3>
                <Image
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-4">
                <h3 className="text-3xl font-bold text-gray-700">Private Math Teacher</h3>
                <Image
                  src="/logos/acadomia_logo.jpeg"
                  alt="Acadomia logo"
                  className="w-8 h-8"
                  width={150}
                  height={150}
              ...
              <p className="text-sm text-gray-500">Paris | Jan 2025 - Current </p>
              <p className="mt-2 text-gray-600 text-2xl">
                Private math tutor for high school students in Ile-de-France. Giving personalized guidance to help students excel in school and achieve their academic goals.
              </p>
          </div>

          <div className="mb-6">
            <div className="flex items-center space-x-4">
                <h3 className="text-3xl font-bold text-gray-700">Information Security Intern</h3>
                <Image
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-4">
                <h3 className="text-3xl font-bold text-gray-700">Data Analysis Internship</h3>
                <Image
                  src="/logos/grant_thornton_luxembourg_logo.jpeg"
                  alt="University of Luxembourg logo"
                  className="w-8 h-8"
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-4">
              <h3 className="text-3xl font-bold text-gray-700">Augmented Reality Internship</h3>
              <Image
      ...
      <section className="bg-white shadow-lg rounded-lg p-6">
          <h2 className="text-5xl font-semibold text-gray-800 mb-4">Education</h2>
          {/* Degree 1 */}
          <div className="mb-6">
              <div className="flex items-center space-x-4">
                  <h3 className="text-3xl font-bold text-gray-700">Master&apos;s in AI, ML, and Data Science</h3>
                  <Image
          ...
          <div className="mb-6">
              <div className="flex items-center space-x-4">
                  <h3 className="text-3xl font-bold text-gray-700">Bachelor&apos;s in Computer Science</h3>
                  <Image
                    src="/logos/university_of_luxembourg_logo.jpeg"
                    alt="University of Luxembourg logo"
                    className="w-8 h-8"
